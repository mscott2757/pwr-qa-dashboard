      ...
      React.DOM.div
        ...
        React.DOM.div
          ...
          React.DOM.h3
            ...
            "Delete #{ @props.app.name }"
          React.DOM.p
            className: 'delete-subtitle'
            "Warning: this application is associated with the following tests"
        React.DOM.div
          ...
          React.DOM.div
            ...
            React.DOM.ul
              id: "test-tabs-list"
              React.DOM.li
                className: "test-tabs-item"
                React.DOM.a
                  className: "test-tabs-link"
                  href: "#primary-tests-tab"
                  "Primary Tests"
              React.DOM.li
                className: "test-tabs-item"
                React.DOM.a
                  className: "test-tabs-link"
                  href: "#indirect-tests-tab"
                  "Indirect Tests"

            React.DOM.div
              className: 'test-tabs-body'
              id: "primary-tests-tab"
              React.DOM.ul
                className: 'list-group'
                id: 'delete-modal-tests'
                for test in @props.app.primary_tests
                  React.createElement DeleteModalTest, test: test, key: test.id

            React.DOM.div
              className: 'test-tabs-body'
              id: "indirect-tests-tab"
              React.DOM.ul
                className: 'list-group'
                id: 'delete-modal-tests'
          ...
          React.DOM.div
            ...
            React.DOM.a
              className: 'btn btn-default delete-modal-button'
              onClick: @props.handleClose
              'Cancel'
            React.DOM.a
              className: 'btn btn-danger delete-modal-button'
